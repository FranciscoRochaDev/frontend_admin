...
import { DraftProductSchema, ProductSchema, ProductsShchema, type Product } from "../types";
...
export async function getProducts() {
    ...
    try {
        ...
        const result = safeParse(ProductsShchema, data.data)
        if(result.success){
